...
const tagsForNamePrefix = ['Advanced', 'Demonstration', 'Report Toaster', 'Tutorial']
    ...
    try {
      ...
      if (task.tags) {
        ...
        task.tags = task.tags.map(
          givenTag =>
            taskSchema.properties.tags.items.enum.find(validTag => validTag.toLowerCase() === givenTag.toLowerCase()) ||
            givenTag
        )
