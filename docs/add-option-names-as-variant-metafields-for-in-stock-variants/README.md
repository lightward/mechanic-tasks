...
__Important:__ To use OS 2.0 collection and search filtering, you must configure variant metafield definitions for each metafield key configured in this task. Read Shopify's documentation on [adding metafield definitions](https://help.shopify.com/en/manual/custom-data/metafields/metafield-definitions) for more info.
