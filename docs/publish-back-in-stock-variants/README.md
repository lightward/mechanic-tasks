# Publish back-in-stock variants

Tags: In stock, Inventory, Location, Publish, Variants
...
* View in the task library: [tasks.mechanic.dev/publish-back-in-stock-variants](https://tasks.mechanic.dev/publish-back-in-stock-variants)
* Task JSON, for direct import: [task.json](../../tasks/publish-back-in-stock-variants.json)
...
```json
{
  "always_exclude_products_with_any_of_these_tags__array": [],
  "back_in_stock_inventory_quantity__number_required": "1",
  "email_notification_recipient__email": null,
  "only_include_inventory_from_these_location_names__array": [],
  "only_include_products_with_any_of_these_tags__array": [],
...
Find this task [in the library at tasks.mechanic.dev](https://tasks.mechanic.dev/publish-back-in-stock-variants), and use the "Try this task" button. Or, import [this task's JSON export](../../tasks/publish-back-in-stock-variants.json) – see [Importing and exporting tasks](https://learn.mechanic.dev/core/tasks/import-and-export) to learn how imports work.
